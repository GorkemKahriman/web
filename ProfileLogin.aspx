  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding-red">Silahlar</a>
        ...
        <div >
            ...
            <h1>Değişiklik Yapabilmek İçin Şifrenizi Giriniz:</h1>
            <h1>
                <asp:TextBox ID="TextBox1" runat="server" TextMode="Password"></asp:TextBox>
                <br />
               <br /> <asp:Button ID="btn_degistir" runat="server" Text="Güncelle" Font-Bold="True" Height="44px" Width="315px" BackColor="#009900" BorderColor="Black" OnClick="btn_degistir_Click" />
            </h1>
            <p> <asp:Button ID="btn_cikis" runat="server" Text="Çıkış Yap" Font-Bold="True" Height="44px" Width="315px" BackColor="#6699FF" BorderColor="Black" OnClick="btn_cikis_Click" />
            </p>
            <p>
                <asp:Button ID="btn_hesabisil" runat="server" BackColor="Red" BorderColor="Black" Font-Bold="True" Height="30px" OnClick="btn_hesabisil_Click" Text="Hesabımı Sil" Width="313px" />
            </p>
            <p>&nbsp;</p>
