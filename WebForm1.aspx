<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="DenemeCss.WebForm1" %>
...
body{background-color:;
     background-image:url(https://wallpapercave.com/wp/wp4578133.png);
...
<!-- Header -->
<header class="w3-container w3-gray w3-center" style="padding:128px 12px">
  <h1 class="w3-margin w3-jumbo">Apex Legends Wiki  </h1>
  <p class="w3-xlarge">Hoşgeldiniz</p>
</header>
